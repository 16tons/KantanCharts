...
public:
	...
	/**
	 * Adds a marker to the given series.
	 */
	UFUNCTION(BlueprintCallable, Category = "Data", Meta = (DisplayName = "Add Marker"))
	void BP_AddMarker(FName SeriesId, float const Time, int32 MarkerId, bool& bSuccess);
